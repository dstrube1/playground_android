package com.dstrube.jsontest.view;
...
import com.dstrube.jsontest.service.ImageLoader;
...
public class CustomAdapter extends SimpleAdapter {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		TextView firstNameView = (TextView) view.findViewById(R.id.fName);
		TextView lastNameView = (TextView) view.findViewById(R.id.lName);
...
//		Context ctx = view.getContext();
		//wait, why not use the context from the contructor?
		//TODO: test this^
