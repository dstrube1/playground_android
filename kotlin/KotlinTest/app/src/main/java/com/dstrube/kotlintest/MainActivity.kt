...
//The sealed keyword used to not make this app crash
/*sealed*/ /*as opposed to `open`, ie, inheritable / extendable */ class MainActivity : AppCompatActivity() {
    ...
    override fun onResume() {
        ...
        //String? is nullable
        val myText: String? = "TextView value is set in onResume"
        //String is not
