...
public class MainActivity extends Activity implements
    ...
    public static class PlaceholderFragment extends Fragment {
        ...
        private void section2(ViewGroup container, LayoutInflater inflater) {
            container.removeAllViews();
            // Custom Toast
//			Button button = new Button(container.getContext());
//			button.setText("Click for custom toast");
...
//			});
            ...
            //handling this in Main
        }

        private void section3(ViewGroup container) {
//			container.removeView(timePicker);
            container.removeAllViews();
            DatePicker datePicker = new DatePicker(container.getContext());
