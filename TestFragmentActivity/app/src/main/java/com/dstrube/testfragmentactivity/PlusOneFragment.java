...
public class PlusOneFragment extends Fragment {
    ...
    //Useful if we want a singleton of this class
    public static PlusOneFragment newInstance(final String param1, final String param2) {
        final PlusOneFragment fragment = new PlusOneFragment();
    ...
    public void onResume() {
        ...
        String PLUS_ONE_URL = "http://developer.android.com";
    ...
    interface OnFragmentInteractionListener {
        ...
        void onFragmentInteraction(final Uri uri);
    }
